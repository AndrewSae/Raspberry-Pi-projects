...
while True:    # a infinite loop
    while x <= len(led):    # if "x" is less or equal to the length of the array "led" the indented code will run
        led[x].on()    # turns on the led that is at the position of "x" in the array
